        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <p className="text-sm sm:text-base text-neutral-200 font-sans font-light leading-relaxed">
                "{activeTestimonial.content}"
              </p>

              <div className="pt-6 border-t border-white/10 flex items-center gap-4">
                <div className="w-14 h-14 rounded-full bg-gradient-to-tr from-[#132210] to-[#BAA360] flex items-center justify-center text-white font-extrabold text-lg font-mono shadow-md">
                  {activeTestimonial.initials}
                </div>
                <div>
                  <h3 className="font-display text-base font-bold text-white uppercase tracking-wider">{activeTestimonial.type}</h3>
                  <p className="text-xs text-gold font-mono uppercase tracking-widest mt-1 font-bold font-mono">{activeTestimonial.location}</p>
                </div>
              </div>
            </div>
          </motion.div>
