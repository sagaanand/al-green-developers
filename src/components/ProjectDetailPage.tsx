...
export default function ProjectDetailPage({ projectId, onClose, onBookTour }: ProjectDetailPageProps) {
  ...
  return (
    <div id={`project-detail-panel-${projectId}`} className="w-full h-full overflow-y-auto bg-[#0A0A0A] text-white font-sans antialiased flex flex-col" data-lenis-prevent>
