...
export default function SectionCallbackCTA() {
  return (
    <section className="relative w-full bg-gradient-to-br from-[#0d1f0c] to-[#24421E] py-24 sm:py-36 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <h2 className="font-mono text-4xl md:text-5xl lg:text-6xl font-bold uppercase mb-6 text-white">
            Discover the Future of <span className="text-gold">Luxury Living</span>
          </h2>
          <p className="text-neutral-300 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed mb-12">
